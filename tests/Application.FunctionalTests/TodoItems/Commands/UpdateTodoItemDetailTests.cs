using CalendarManager.Application.TodoItems.Commands.CreateTodoItem;
using CalendarManager.Application.TodoItems.Commands.UpdateTodoItem;
using CalendarManager.Application.TodoItems.Commands.UpdateTodoItemDetail;
using CalendarManager.Application.TodoLists.Commands.CreateTodoList;
using CalendarManager.Domain.Entities;
using CalendarManager.Domain.Enums;

namespace CalendarManager.Application.FunctionalTests.TodoItems.Commands;

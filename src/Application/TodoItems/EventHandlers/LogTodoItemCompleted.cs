using CalendarManager.Domain.Events;
using Microsoft.Extensions.Logging;

namespace CalendarManager.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("CalendarManager Domain Event: {DomainEvent}", notification.GetType().Name);
